...
(use-package latex
  ...
  (flet ((add-unicode-keymap (keys &optional prefix)
    ...
    (let ((greek-letters '(("A" . "GREEK CAPITAL LETTER ALPHA")
	  ...
	  (greek-variant-letters '(("J" . "GREEK CAPITAL THETA SYMBOL")
				   ("k" . "GREEK KAPPA SYMBOL")
				   ("f" . "GREEK PHI SYMBOL")
				   ("p" . "GREEK PI SYMBOL")
				   ("r" . "GREEK RHO SYMBOL")))
	  (mathematical-script-letters '(("A" . "MATHEMATICAL SCRIPT CAPITAL A")
					 ("B" . "SCRIPT CAPITAL B")
	  ...
	  (mathematical-italic-letters '(("A" . "MATHEMATICAL ITALIC CAPITAL A")
	  ...
	  (mathematical-bold-letters '(("A" . "MATHEMATICAL BOLD CAPITAL A")
	  ...
	  (mathematical-bold-italic-letters '(("A" . "MATHEMATICAL BOLD ITALIC CAPITAL A")
	  ...
	  (mathematical-double-struck-letters '(("A" . "MATHEMATICAL DOUBLE-STRUCK CAPITAL A")
	  ...
	  (subscript-symbols '(("0" . "SUBSCRIPT ZERO")
			       ("1" . "SUBSCRIPT ONE")
			       ("2" . "SUBSCRIPT TWO")
			       ("3" . "SUBSCRIPT THREE")
			       ("4" . "SUBSCRIPT FOUR")
	  ...
	  (mathematical-operators '(("A" . "FOR ALL")
				    ("E" . "THERE EXISTS")
